            ...
            <div class="first-journal">
              <div class="plus-btn">
                ...
                >
                  ...
                  <g
                    id="Light_FAB_3._Mini_Resting"
                    data-name="Light 🌕/ FAB / 3. Mini/Resting"
                    transform="translate(15 14)"
                  >
                    <g
                      id="Circle_Elevation_Dark_04dp"
                      data-name="Circle Elevation/Dark 🌑/04dp"
                    ...
                    <g id="State" clip-path="url(#clip-path)">
                      <g
                        id="States_Light_Primary_Container"
                        data-name="States/Light 🌕/Primary Container"
                      >
                        <rect
                          id="States_Light_Primary_Container_100_Overlay"
                          data-name="States/Light 🌕/Primary Container 100%/Overlay"
                    ...
                    >
                      ...
                      <path
                        id="_Color"
                        data-name=" ↳Color"
                        d="M14,8H8v6H6V8H0V6H6V0H8V6h6Z"
                        transform="translate(5 5)"
                        fill="rgba(247,248,244,0.87)"
                      />
                    </g>
                  </g>
                </svg>
              </div>
              <div class="first-journal-word">Add Your First Journal!</div>
            </div>
          </router-link>
        </div>

        <PersonalFeed :travelList="travelList" />
      </div>
    </div>
  </div>
</template>
