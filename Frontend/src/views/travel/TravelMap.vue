<template>
  <div class="travelmap">
    <div class="header">
      ...
      <div>
        <button class="btn" @click="clickEdit" style="margin: 20px">
          Edit
        </button>
      </div>
    </div>
            ...
            >
              <div class="window-wrap" @click="openModal(nowPlace)">
                ...
                <div class="content">
                  ...
                  <span
                    ><i class="fas fa-star" style="color: #ed7766"></i>
                    {{ nowPlace.placeRate }}</span
                  >
    ...
    <div class="info-section">
      ...
      <div class="date">
        DATE : {{ travel.startDate.substr(0, 10) }} -
        {{ travel.endDate.substr(0, 10) }}
      </div>
    </div>
  </div>
</template>
  ...
  created() {
    ...
    for (let image of this.images) {
      ...
      (marker.windowOpen = false),
        (marker.imgUrl =
          "https://i5a404.p.ssafy.io/api/image/" + image.imageOriginTitle);
      const avgRate =
        (image.placeRates.rate1 +
          image.placeRates.rate2 +
          image.placeRates.rate3) /
        3;
