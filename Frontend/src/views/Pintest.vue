<template>
  <div class="pintest">
    <GmapMap ref="mapRef" :center="center" :zoom="2" class="google-map">
      <gmap-marker
    ...
    <div v-if="marker.modal" class="modal">
        ...
        <div class="text">
          ...
          <fieldset class="category">
            ...
            <div class="category-btns">
              <button @click="clickBtn('hotel')" class="hotel">
                <img src="../assets/icon/hotel-icon.png" alt="hotel-icon" />
              </button>
              <button @click="clickBtn('res')" class="res">
                <img src="../assets/icon/res-icon.png" alt="res-icon" />
              </button>
              <button @click="clickBtn('activity')" class="activity">
                <img
                  src="../assets/icon/activity-icon.png"
                  alt="activity-icon"
                />
              </button>
            </div>
          ...
          <fieldset class="transport">
            ...
            <div
              class="nothing"
              :class="{
                hotel: categoryBind['hotel'],
                res: categoryBind['res'],
                activity: categoryBind['activity'],
              }"
            >
